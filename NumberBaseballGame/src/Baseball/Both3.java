 ...
 * */
public class Both3 extends JPanel{
	PausePanel pf;
	Main main;
	Container con;
	InputNum ipt;
	...
	public Both3() {
		setSize(878,944);
		setLayout(null);
		p1 = new PlayerPanel("Player1");
		p2 = new PlayerPanel("Player2");
		fp = new FinalPanel();
		...
		JLabel fpanelback = new JLabel("");
		fpanelback.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("���â1.JPG"))));
		fpanelback.setSize(500, 80);
		fp.buttonpanel.add(fpanelback);
		...
		label1 = new JLabel("");
		label1.setBounds(0, 790, 175, 154);
		PlayPanel.add(label1);
		label1.setOpaque(false);
		label1.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("�Է�.png"))));

		label2 = new JLabel("");
		label2.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("�Է�.png"))));
		label2.setBounds(175, 790, 175, 154);
		PlayPanel.add(label2);
		label2.setOpaque(false);


		label3 = new JLabel("");
		label3.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("�Է�.png"))));
		label3.setBounds(350, 790, 175, 154);
		PlayPanel.add(label3);
		label3.setOpaque(false);

		InputPanel3 inputpanel = new InputPanel3();
		...
		ScoreBoardInning9 scoreboard = new ScoreBoardInning9();
		PlayPanel.add(scoreboard);
		scoreboard.add(p1);
		scoreboard.add(partition);
		scoreboard.add(p2);
		partition.setBounds(439, 0, 60, 520);
		p2.setBounds(499, 0, 379, 520);
		scoreboard.setComponentZOrder(p1, 0);
		scoreboard.setComponentZOrder(p2, 0);
	...
	JButton makeEnterButton(String name, int ke){ // ��ư ���� �̸��� name���� �ް� ke�� ���� keyevent�� �޴´�
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Both3.inputCount==1);
				if(Both3.inputCount==2);
					...
					if(Both3.turnCount%2==0){  // ��ī��Ʈ�� ¦���̸� �÷��̾�1����
						InningLogic.compare1=InningLogic.compareNum2(InningLogic.player1Input.elementAt(0), InningLogic.player1Input.elementAt(1), InningLogic.player1Input.elementAt(2));
						ip = new InningPanel3();
						p1.add(ip);
						audioClip.stop();
						audioClip2.play();
						...
						InningLogic.compare2=InningLogic.compareNum1(InningLogic.player2Input.elementAt(0), InningLogic.player2Input.elementAt(1), InningLogic.player2Input.elementAt(2));
						ip = new InningPanel3();
						p2.add(ip);
						audioClip2.stop();
						audioClip.play();
						audioClip3.play();
						InningLogic.deleteAllInput(InningLogic.player2Input);

						if(InningLogic.compare1.equals("3S0B")){
							if(InningLogic.compare2.equals("3S0B")){//���ºζ�
								...
								talkLabel.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("���º�.png"))));
								...
								fp.setEnabled(true);
								JLabel talkLabel = new JLabel("");
								talkLabel.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("p1�¸�.png"))));
								talkLabel.setBounds(209, 272, 240, 170);
								add(talkLabel);
								setComponentZOrder(talkLabel,0);
							}
							...
							if(InningLogic.compare2.equals("3S0B")){//player2�¸�
								fp.requestFocus();
								fp.setVisible(true);
								fp.setEnabled(true);
								JLabel talkLabel = new JLabel("");
								talkLabel.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("p2�¸�.png"))));
								talkLabel.setBounds(209, 272, 240, 170);
								add(talkLabel);
								setComponentZOrder(talkLabel,0);
							}
						}
						if(turnCount==17){  // �Ѵ� ���� Ƚ���� �Ѱ� ���º�
							fp.requestFocus();
							fp.setVisible(true);
							fp.setEnabled(true);
							JLabel talkLabel = new JLabel("");
	...
	JButton Numberbutton(String name,int input){ // ��ư ���� �̸��� name���� �ް� ke�� ���� keyevent�� �޴´�
		String s = name + input;
		String imgName = "num"+(input-48)+".png";
			...
			public void actionPerformed(ActionEvent e) {
				if(inputCount==0){
					...
					if(turnCount%2==0)
						...
						InningLogic.InputPlayer2(input-48);
				}
