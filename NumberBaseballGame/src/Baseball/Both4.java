 ...
 * */
public class Both4 extends JPanel{
	PausePanel pf;
	Main main;
	Container con;
	InputNum ipt;
	...
	public Both4() {
		...
		scoreboard.add(p2);
		partition.setBounds(421, 0, 96, 520);
		p2.setBounds(517, 0, 361, 546);
	...
	JButton makeEnterButton(String name, int ke){ // ��ư ���� �̸��� name���� �ް� ke�� ���� keyevent�� �޴´�
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					if(Both4.inputCount==1);
					if(Both4.inputCount==2);
					if(Both4.inputCount==3);
					else if(Both4.inputCount==4){
						Both4.inputCount=0;
						Both4.label1.setIcon(null);
						...
						if(Both4.turnCount%2==0){  // ��ī��Ʈ�� ¦���̸� �÷��̾�1����
							InningLogic.compare1=InningLogic.compareNum2_4(InningLogic.player1Input.elementAt(0), InningLogic.player1Input.elementAt(1), InningLogic.player1Input.elementAt(2),InningLogic.player1Input.elementAt(3));
							ip = new InningPanel4();
							p1.add(ip);
							audioClip.stop();
		                    audioClip2.play();
							...
							InningLogic.compare2=InningLogic.compareNum1_4(InningLogic.player2Input.elementAt(0), InningLogic.player2Input.elementAt(1), InningLogic.player2Input.elementAt(2),InningLogic.player2Input.elementAt(3));
							ip = new InningPanel4();
							p2.add(ip);
							audioClip2.stop();
							audioClip.play();
							...
							if(InningLogic.compare1.equals("4S0B")){
								...
								if(InningLogic.compare2.equals("4S0B")){//���ºζ�
								fp.requestFocus();
								fp.setVisible(true);
								fp.setEnabled(true);
								...
								if(InningLogic.compare2.equals("4S0B")){//player2�¸�
									fp.requestFocus();
									fp.setVisible(true);
									fp.setEnabled(true);
									JLabel talkLabel = new JLabel("");
