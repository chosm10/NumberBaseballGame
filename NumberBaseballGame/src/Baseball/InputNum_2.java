...
public class InputNum_2 extends JPanel {
	Both3 both3;
	Both4 both4;
	int count=0;
	...
	public InputNum_2() {
		...
		Player2Image.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("Player2���ӽ���.JPG"))));
		Player2Image.setBounds(174, 172, 500, 600);
		panel.add(Player2Image);
		...
		button0.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(0));
					else{	
						InningLogic.setSecret2(0);
						count++;

						if(count == InningLogic.whatBall){

							JButton GameContinue = new JButton("");
							GameContinue.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("���ӽ��� ��.JPG"))));
							GameContinue.setBounds(213, 657, 421, 68);
							ButtonPanel.add(GameContinue);
							GameContinue.addActionListener(new ActionListener(){
								public void actionPerformed(ActionEvent e)
								{
									//�׼� ������ ������
									if (e.getSource() == GameContinue)
									{
										setEnabled(false);
										setVisible(false);
										if(InningLogic.whatBall == 3){
											both3 = new Both3();
											GFrame.con.add(both3);
											both3.setEnabled(true);
											both3.setVisible(true);
										}
										else if(InningLogic.whatBall == 4){
											both4 = new Both4();
											GFrame.con.add(both4);
											both4.setVisible(true);
											both4.setEnabled(true);
										}
									}
								}});
						}
		...
		button1.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(1));
					else{	
						InningLogic.setSecret2(1);
						count++;
		...
		button2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(2));
					else{	
						InningLogic.setSecret2(2);
						count++;
		...
		button3.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(3));
					else{	
						InningLogic.setSecret2(3);
						count++;
		...
		button4.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(4));
					else{	
						InningLogic.setSecret2(4);
						count++;
		...
		button5.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(5));
					else{	
						InningLogic.setSecret2(5);
						count++;
		...
		button6.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(6));
					else{	
						InningLogic.setSecret2(6);
						count++;
		...
		button7.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(7));
					else{	
						InningLogic.setSecret2(7);
						count++;
		...
		button8.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(8));
					else{	
						InningLogic.setSecret2(8);
						count++;
		...
		button9.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					if(InningLogic.player2.contains(9));
					else{	
						InningLogic.setSecret2(9);
						count++;
