 ...
 * */
public class Single3 extends JPanel {
	PausePanel pf;
	Main main;
	InputNum ipt;
	Container con;
	...
	public Single3() {
		...
		rebutton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				Single3 sing3 = new Single3();
				InningLogic.setRandomVector();
				GFrame.con.add(sing3);
	 ...
	 * ���� ��ư�� ���� ������ �Ҹ��� ����, ���ڰ� �Էµȴ�.
	 */
	public JButton makeEnterButton(String name, int ke){ // ��ư ���� �̸��� name���� �ް� ke�� ���� keyevent�� �޴´�
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Single3.inputCount==1);
				if(Single3.inputCount==2);
				else if(Single3.inputCount==3){
					Single3.inputCount=0;
					InningLogic.compare1=InningLogic.singleCompareNum3(InningLogic.player1Input.elementAt(0), InningLogic.player1Input.elementAt(1), InningLogic.player1Input.elementAt(2));
